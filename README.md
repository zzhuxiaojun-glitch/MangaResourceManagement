...
- 首页展示最近更新的作品和三大分类入口
- 顶部导航：漫画、动画、电子书三大分类
- 漫画页面支持标签筛选（漫画家作品合集、生肉日漫、BL/GL等）
- 全站搜索作品（支持标题、别名、作者、标签）
- 状态筛选（有效/失效/待补/连载中/已完结）
- 查看作品详情和资源链接
- 一键复制链接和提取码

### 管理功能（需要登录）
- 仪表盘：查看统计数据、快速添加资源、批量导入入口
- 分类管理：管理三大分类（漫画、动画、电子书）
- 作品管理：增删改作品信息，支持多标签管理
...
**注意：** 原来的子分类（如"漫画家作品合集"、"生肉日漫"等）已整合为漫画分类下的标签，可在漫画页面通过标签筛选。
...
### 管理路由（需要登录）
- `/admin` - 管理仪表盘（含快速入口）
- `/admin/login` - 登录页面（仅登录，无注册）
- `/admin/categories` - 分类管理
- `/admin/titles` - 作品列表
- `/admin/titles/new` - 新建作品
- `/admin/titles/[id]` - 编辑作品和资源
- `/admin/import` - CSV 批量导入
